...
public class AqlMetadataProvider implements IMetadataProvider<AqlSourceId, String> {
    ...
    public Pair<IOperatorDescriptor, AlgebricksPartitionConstraint> getTokenizerRuntime(
            List<LogicalVariable> tokenizedKeys, List<Object> keyTypes) {
        IBinaryTokenizerFactory tokenizerFactory = NonTaggedFormatUtil.getBinaryTokenizerFactory(keyTypes);

        BinaryTokenizerOperatorDescriptor tokenizerOp = new BinaryTokenizerOperatorDescriptor(spec, tokenKeyPairRecDesc,
                tokenizerFactory, docField, keyFields, isPartitioned, true);
        ...
        AlgebricksPartitionConstraint partitionConstraint = new AlgebricksCountPartitionConstraint(loc);
