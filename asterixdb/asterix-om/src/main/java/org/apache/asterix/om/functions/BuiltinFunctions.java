...
public class BuiltinFunctions {
    ...
    //Geo
    public static final FunctionIdentifier ST_AREA = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-area", 1);
    public static final FunctionIdentifier ST_MAKE_POINT = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-make-point", 2);
    public static final FunctionIdentifier ST_MAKE_POINT3D = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-make-point", 3);
    public static final FunctionIdentifier ST_MAKE_POINT3D_M = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-make-point", 4);
    ...
    public static final FunctionIdentifier ST_IS_COLLECTION = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-is-collection", 1);
    public static final FunctionIdentifier ST_CONTAINS = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-contains", 2);
    public static final FunctionIdentifier ST_CROSSES = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-crosses", 2);
    public static final FunctionIdentifier ST_DISJOINT = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-disjoint", 2);
    public static final FunctionIdentifier ST_EQUALS = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-equals", 2);
    public static final FunctionIdentifier ST_OVERLAPS = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-overlaps", 2);
    public static final FunctionIdentifier ST_TOUCHES = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-touches", 2);
    public static final FunctionIdentifier ST_WITHIN = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-within", 2);
    ...
    public static final FunctionIdentifier ST_COORD_DIM = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-coord-dim", 1);
    public static final FunctionIdentifier ST_DIMENSION = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-dimension", 1);
    public static final FunctionIdentifier GEOMETRY_TYPE = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "geometry-type", 1);
    public static final FunctionIdentifier ST_M = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-m", 1);
    public static final FunctionIdentifier ST_N_RINGS = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-n-rings", 1);
    public static final FunctionIdentifier ST_N_POINTS = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-n-points", 1);
    public static final FunctionIdentifier ST_NUM_GEOMETRIIES = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-num-geometries", 1);
    public static final FunctionIdentifier ST_NUM_INTERIOR_RINGS = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-num-interior-rings", 1);
    public static final FunctionIdentifier ST_SRID = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-srid", 1);
    public static final FunctionIdentifier ST_X = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-x", 1);
    ...
    public static final FunctionIdentifier ST_X_MIN = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-x-min", 1);
    public static final FunctionIdentifier ST_Y_MAX = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-y-max", 1);
    public static final FunctionIdentifier ST_Y_MIN = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-y-min", 1);
    public static final FunctionIdentifier ST_Z = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-z", 1);
    public static final FunctionIdentifier ST_Z_MIN = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-z-min", 1);
    public static final FunctionIdentifier ST_Z_MAX = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-z-max", 1);
    public static final FunctionIdentifier ST_AS_BINARY = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-as-binary", 1);
    public static final FunctionIdentifier ST_AS_TEXT = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-as-text", 1);
    public static final FunctionIdentifier ST_AS_GEOJSON = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-as-geojson", 1);
    public static final FunctionIdentifier ST_DISTANCE = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-distance", 2);
    public static final FunctionIdentifier ST_LENGTH = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-length", 1);
    ...
    public static final FunctionIdentifier ST_GEOM_FROM_TEXT_SRID = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-geom-from-text", 2);
    public static final FunctionIdentifier ST_GEOM_FROM_WKB = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-geom-from-wkb", 1);
    ...
    public static final FunctionIdentifier ST_IS_CLOSED = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-is-closed", 1);
    public static final FunctionIdentifier ST_IS_RING = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-is-ring", 1);
    public static final FunctionIdentifier ST_RELATE = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-relate", 3);
    public static final FunctionIdentifier ST_BOUNDARY = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-boundary", 1);
    public static final FunctionIdentifier ST_END_POINT = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-end-point", 1);
    public static final FunctionIdentifier ST_ENVELOPE = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-envelope", 1);
    public static final FunctionIdentifier ST_EXTERIOR_RING = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-exterior-ring", 1);
    public static final FunctionIdentifier ST_GEOMETRY_N = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-geometry-n", 2);
    public static final FunctionIdentifier ST_INTERIOR_RING_N = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-interior-ring-n", 2);
    public static final FunctionIdentifier ST_POINT_N = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-point-n", 2);
    public static final FunctionIdentifier ST_START_POINT = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-start-point", 1);
    public static final FunctionIdentifier ST_DIFFERENCE = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-difference", 2);
    public static final FunctionIdentifier ST_INTERSECTION = new FunctionIdentifier(FunctionConstants.ASTERIX_NS,
            "st-intersection", 2);
    ...
    static {
        ...
        scalarToAggregateFunctionMap.put(getAsterixFunctionInfo(SCALAR_ST_UNITON_AGG), getAsterixFunctionInfo(ST_UNITON_AGG));
    }
    ...
    static {
        ...
        addAgg(ST_UNITON_AGG);
        addLocalAgg(ST_UNITON_AGG, ST_UNITON_AGG);
        addIntermediateAgg(ST_UNITON_AGG, ST_UNITON_AGG);
        addGlobalAgg(ST_UNITON_AGG, ST_UNITON_AGG);
    }
