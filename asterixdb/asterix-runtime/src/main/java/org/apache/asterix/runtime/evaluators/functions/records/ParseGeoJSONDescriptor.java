...
public class ParseGeoJSONDescriptor extends AbstractScalarFunctionDynamicDescriptor {
    ...
    public static final IFunctionDescriptorFactory FACTORY = new IFunctionDescriptorFactory() {
        ...
        public IFunctionTypeInferer createFunctionTypeInferer() {
            return new FunctionTypeInferers.GeometryConstructorTypeInferer();
        }
    };
        ...
        return new IScalarEvaluatorFactory() {
            ...
            public IScalarEvaluator createScalarEvaluator(IHyracksTaskContext ctx) throws HyracksDataException {
                ...
                return new IScalarEvaluator() {
                    ...
                    private OperatorImportFromGeoJson geoJsonImporter = OperatorImportFromGeoJson.local();
                    ...
                    public void evaluate(IFrameTupleReference tuple, IPointable result) throws HyracksDataException {
                        ...
                        try {
                            String geometry =
                                    recordToString(new ARecordSerializerDeserializer(recType).deserialize(dataIn));
                            MapOGCStructure structure = geoJsonImporter.executeOGC(0, geometry, null);
                            OGCGeometry ogcGeometry = OGCGeometry.createFromOGCStructure(structure.m_ogcStructure,
